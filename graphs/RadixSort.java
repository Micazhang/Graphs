...
public class RadixSort
{
    ...
    public static void main( String [ ] args )
    {
        ...
        for (int z = 4; z <= 10; z += 2)
        {
        		...
        		for (int j = 0; j < 10; j++)
        		{
        			RandomStringGenerator ran = new RandomStringGenerator();
        			for(int i = 0; i < 100000; i++)
        			{
        				String str;
        				str = ran.RandomString(z);
        				lst.add(str);
        			}
        			lst.toArray(arr1);
        			lst.toArray(arr2);
        			...
        			start_time = System.nanoTime();
        			countingRadixSort(arr2, z);
        			total_time2 += System.nanoTime() - start_time;
        			lst.clear();
        		}
        		System.out.println("Radixsort for "+ z +" length:" + total_time1/10);
        		System.out.println("Radixcount sort for " + z + " length :" + total_time2/10);
